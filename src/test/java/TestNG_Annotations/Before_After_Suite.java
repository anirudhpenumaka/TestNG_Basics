...
{	
	@BeforeSuite
	void BeforeSuite() {
	    System.out.println("Runs BEFORE every Suite in xml");
	}
	
	@BeforeTest
	void BeforeTest() {
	    System.out.println("Runs BEFORE every Test in xml");
	}
	...
	@AfterTest
	void AfterTest() {
	    System.out.println("Runs AFTER every Test in xml");
	}
	
	@AfterSuite
	void AfterSuite() {
	    System.out.println("Runs AFTER Suite in xml");
	}
}
